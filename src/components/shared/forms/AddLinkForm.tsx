...
import { Layers2, Loader, X } from "lucide-react";
import { useState } from "react";

interface AddLinkFormProps {
  onSave: (newLink: Omit<QuickLink, "id" | "icon">) => void;
  onCancel: () => void;
  isLoading: boolean;
}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex w-full space-x-3 pt-2">
            ...
            <button
              ...
              disabled={isLoading || !newLink.url}
            >
              {isLoading ? (
                <>
                ...
                <p className="font-medium">Add Shortcut</p>
              )}
            </button>
          </div>
        </form>
